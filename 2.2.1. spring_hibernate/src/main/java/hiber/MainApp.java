...
public class MainApp {
    public static void main(String[] args) {
        ...
        userService.add(new User("User1", "Lastname1", "user1@mail.ru", new Car(777, "BMW")));
        ...
        Car car = new Car(444, "Ford");
        User carOwner = userService.getUserByCar(car);
        System.out.println("Владелец машины "+car.getModel()+" "+carOwner);
